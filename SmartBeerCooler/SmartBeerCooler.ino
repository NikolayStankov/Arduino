 ...
 * wiper to LCD VO pin (pin 3)
  ...
  One wire bus with 4K7 pull up connected to it:
   OneWireBus -Pin 6
*/
...
#define ONE_WIRE_BUS 6 //Defines the OneWire Netrwok-a pin 
...
void setup() {
 ...
 pinMode (Peltier,OUTPUT);
  ...
  sensors.begin(); //Start the onewire bus sensors
...
void loop() { 
  ...
  void Temperatures(void)
  {
    ...
    if( TempMeasurementFlag == 0)
    {
     ...
     TempPeltier2 = sensors.getTempCByIndex(0);
